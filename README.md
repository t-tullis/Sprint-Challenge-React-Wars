...
- React is a user interface component library. It tries to help solve problems dealing with complex state. Being able to work with the state of the DOM, structure is stored. So when there is any updates to be made to the UI, updates only happen to the ones that have changed. Allowing DOM operations/refreshes to be reduced, which improves performance. 

- [x] What does it mean to _think_ in react?

- To think in react is to think in components and state.   

- [x] Describe state.

- State is the data that our components can hold onto and pass around to other components. When state updates so will our components. 


- [x] Describe props.

- Props are properties that are passed through out an application. Such as data being used in a current state that can be passed down to be used in different components.
